...
public class UiView : MonoBehaviour
{
    ...
    public virtual void OnEnable()
    {
        if (firstSelected != null)
            SetFirstSelectedByEventSystem(firstSelected);
    }

    public void SetFirstSelectedByEventSystem(GameObject objectToSelect)
    {
        EventSystem.current.firstSelectedGameObject = objectToSelect;
